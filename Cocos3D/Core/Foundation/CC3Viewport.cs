...
namespace Cocos3D
{
    public struct CC3Viewport : IEquatable<CC3Viewport>
    {
        ...
        public static bool operator ==(CC3Viewport value1, CC3Viewport value2)
        {
        ...
        public CC3Viewport(int x, int y, int width, int height)
        {
            _xnaViewport = new Viewport(x, y, width, height);
        }

        public CC3Viewport(CC3Viewport vp, int xOffset, int yOffset, int widthOffset, int heightOffset)
        : this(vp.X + xOffset, vp.Y + yOffset, vp.Width + widthOffset, vp.Height + heightOffset)
        {

        }

        public CC3Viewport(CCRect rect)
        : this((int)rect.Origin.X, (int)rect.Origin.Y, (int)rect.Size.Width, (int)rect.Size.Height)
        {
 
        }

        internal CC3Viewport(Viewport xnaViewport)
        ...
        public override bool Equals(object obj)
        {
            ...
            return (obj is CC3Viewport) ? this == (CC3Viewport)obj : false;
        }

        public bool Equals(CC3Viewport other)
        {
            // Using overloaded == operator
            return this == other;
        }
